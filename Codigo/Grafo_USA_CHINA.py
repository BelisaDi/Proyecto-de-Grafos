...
G.add_edge('USA','AUS', capacity = 29500, weight=9)
G.add_edge('USA','BRA', capacity = 29400, weight=4)
G.add_edge('USA','CAN', capacity = 158600, weight=2)
G.add_edge('USA','DEU', capacity = 70500, weight=5)
G.add_edge('USA','ESP', capacity = 23800, weight=5)
G.add_edge('USA','FRA', capacity = 46300, weight=5)
G.add_edge('USA','GBR', capacity = 55600, weight=4)
G.add_edge('USA','HKG', capacity = 39400, weight=7)
G.add_edge('USA','ITA', capacity = 25600, weight=5)
G.add_edge('USA','JPN', capacity = 75900, weight=6)
G.add_edge('USA','KOR', capacity = 57700, weight=6)
G.add_edge('USA','MEX', capacity = 190600, weight=1)
G.add_edge('USA','MYS', capacity = 23600, weight=9)
G.add_edge('USA','NLD', capacity = 44100, weight=4)
G.add_edge('USA','SGP', capacity = 33300, weight=9)

"""
ARISTAS DE IMPORTACIONES CHINENSES
"""

G.add_edge('AUS','CHN', capacity = 93900, weight=4)
G.add_edge('BRA','CHN', capacity = 56900, weight=10)
G.add_edge('CAN','CHN', capacity = 27400, weight=6)
G.add_edge('DEU','CHN', capacity = 104000, weight=4)
G.add_edge('ESP','CHN', capacity = 16400, weight=5)
G.add_edge('FRA','CHN', capacity = 31100, weight=5)
G.add_edge('GBR','CHN', capacity = 30900, weight=5)
G.add_edge('HKG','CHN', capacity = 25300, weight=1)
G.add_edge('ITA','CHN', capacity = 25300, weight=5)
G.add_edge('JPN','CHN', capacity = 145000, weight=2)
G.add_edge('KOR','CHN', capacity = 158800, weight=1)
G.add_edge('MEX','CHN', capacity = 17900, weight=7)
G.add_edge('MYS','CHN', capacity = 51500, weight=2)
G.add_edge('NLD','CHN', capacity = 20900, weight=4)
G.add_edge('SGP','CHN', capacity = 59300, weight=2)
