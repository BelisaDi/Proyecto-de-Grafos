...
G.add_edge('USA','AUS', capacity = 20600, weight=9)
G.add_edge('USA','BRA', capacity = 20500, weight=4)
G.add_edge('USA','CAN', capacity = 149700, weight=2)
G.add_edge('USA','CHN', capacity = 133400, weight=7)
G.add_edge('USA','DEU', capacity = 61600, weight=5)
G.add_edge('USA','ESP', capacity = 14900, weight=5)
G.add_edge('USA','FRA', capacity = 37400, weight=5)
G.add_edge('USA','GBR', capacity = 46700, weight=4)
G.add_edge('USA','HKG', capacity = 30500, weight=7)
G.add_edge('USA','ITA', capacity = 16700, weight=5)
G.add_edge('USA','JPN', capacity = 67000, weight=6)
G.add_edge('USA','KOR', capacity = 48800, weight=6)
G.add_edge('USA','MEX', capacity = 181700, weight=1)
G.add_edge('USA','MYS', capacity = 14700, weight=9)
G.add_edge('USA','NLD', capacity = 35200, weight=4)
G.add_edge('USA','SGP', capacity = 24400, weight=9)

"""
ARISTAS DE IMPORTACIONES CHINENSES
"""

G.add_edge('AUS','CHN', capacity = 85000, weight=4)
G.add_edge('BRA','CHN', capacity = 48000, weight=10)
G.add_edge('CAN','CHN', capacity = 18500, weight=6)
G.add_edge('DEU','CHN', capacity = 95100, weight=4)
G.add_edge('ESP','CHN', capacity = 7500, weight=5)
G.add_edge('FRA','CHN', capacity = 22200, weight=5)
G.add_edge('GBR','CHN', capacity = 22000, weight=5)
G.add_edge('HKG','CHN', capacity = 16400, weight=1)
G.add_edge('ITA','CHN', capacity = 16400, weight=5)
G.add_edge('JPN','CHN', capacity = 136100, weight=2)
G.add_edge('KOR','CHN', capacity = 149900, weight=1)
G.add_edge('MEX','CHN', capacity = 9000, weight=7)
G.add_edge('MYS','CHN', capacity = 42600, weight=2)
G.add_edge('NLD','CHN', capacity = 12000, weight=4)
G.add_edge('SGP','CHN', capacity = 50400, weight=2)
